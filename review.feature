Feature: Users can get write a review for a product
  Background:
    ...
    And user selects product(s) s/he would like to leave a review for using navigation bar and dropdown menus


  Scenario: Writing a review for a product
    Given user opens a page with the product(s) s/he would like to leave a review for
